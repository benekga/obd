...
public class Konsola {
    ...
    public Konsola(char rodzajOceny, int idNauczyciela, int idPrzedmiotu, int idUcznia, int idOceny) {
    ...
    public void inputNauczyciel(List<Integer> klucze) {
        ...
        while (waitingForValidInput){
            Scanner myObject = new Scanner(System.in);
            System.out.println("Wprowadź id nauczyciela - dopuszczalne wartości: "+klucze.toString());
            int idNauczyciela = myObject.nextInt();
    ...
    public void inputUczen(List<Integer> klucze) {
        ...
        while (waitingForValidInput){
            Scanner myObject = new Scanner(System.in);
            System.out.println("Wprowadź id ucznia - dopuszczalne wartości: "+klucze.toString());
            int idUcznia = myObject.nextInt();
    ...
    public void inputPrzedmiot(List<Integer> klucze) {
        ...
        while (waitingForValidInput){
            Scanner myObject = new Scanner(System.in);
            System.out.println("Wprowadź id przedmiotu - dopuszczalne wartości: "+klucze.toString());
            int idPrzedmiotu = myObject.nextInt();
    ...
    public void inputOcena(List<Integer> klucze) {
        ...
        while (waitingForValidInput){
            Scanner myObject = new Scanner(System.in);
            System.out.println("Wprowadź id oceny - dopuszczalne wartości: "+klucze.toString());
            int idOceny = myObject.nextInt();
